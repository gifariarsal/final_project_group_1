...
import { editCategory, getCategory } from '../../../redux/reducer/CategoryReducer';

const EditCategoryModal = ({ isOpen, onClose, id }) => {
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values, { resetForm }) => {
        try {
          await dispatch(editCategory(id, values, toast, onClose, resetForm));
